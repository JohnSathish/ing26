  ...
  if (loading) {
    return (
      <div className="province-page">
        <Header />
        <div className="province-content-container">
  ...
  return (
    <div className="province-page">
      ...
      <div className="province-content-container">
        ...
        <h1 className="page-title">Province of Mary Help of Christians ING: Guwahati</h1>
        
        <div className="province-content-wrapper">
          {provinceImage && (
            <div className="province-image-section">
              <img 
                src={provinceImage} 
                alt="Province of Mary Help of Christians" 
                className="province-full-image"
              />
            </div>
          )}
          
          <div 
            className="province-content-text"
            dangerouslySetInnerHTML={{ __html: formatContent(provinceContent) }}
          />
        </div>
      </div>
      <Footer />
