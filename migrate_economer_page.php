<?php
/**
 * Migrate Economer page from WordPress to local site
...
// Configuration
$WORDPRESS_URL = 'https://donboscoguwahati.org/index.php/about-us/the-economers/';
$PAGE_SLUG = 'economer';
$UPLOAD_DIR = __DIR__ . '/public_html/uploads/pages/';
$LOG_FILE = __DIR__ . '/economer_migration_log.txt';
...
function downloadImage($url, $baseUrl, $prefix = 'economer') {
    global $UPLOAD_DIR;
...
// Main execution
logMessage("Starting Economer page migration from: $WORDPRESS_URL");
...
try {
    ...
    foreach ($images as $imageUrl) {
        ...
        $localPath = downloadImage($imageUrl, $WORDPRESS_URL, 'economer');
        if ($localPath) {
